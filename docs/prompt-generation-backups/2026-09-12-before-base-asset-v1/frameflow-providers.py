...
ASSET_INTENT_OUTPUT_SCHEMA = {
    ...
    "properties": {
        ...
        "normalizedIntent": {
            ...
            "properties": {
                "summary": {"type": "string"},
                "stableAnchors": {"type": "array", "items": {"type": "string"}},
                "userAdjustments": {"type": "array", "items": {"type": "string"}},
                "shotSpecificDetails": {"type": "array", "items": {"type": "string"}},
                "mustPreserve": {"type": "array", "items": {"type": "string"}},
                "mustAvoid": {"type": "array", "items": {"type": "string"}},
                "unmatchedMentions": {"type": "array", "items": {"type": "string"}},
            },
            "required": ["summary", "stableAnchors", "userAdjustments", "shotSpecificDetails", "mustPreserve", "mustAvoid", "unmatchedMentions"],
            "additionalProperties": True,
        },
        "warnings": {"type": "array", "items": {"type": "string"}},
        "unmatchedMentions": {"type": "array", "items": {"type": "string"}},
    },
    "required": ["assetId", "assetClass", "normalizedIntent", "warnings", "unmatchedMentions"],
    "additionalProperties": True,
}

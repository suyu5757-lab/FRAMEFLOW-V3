...
export const studioApi = {
  ...
  refreshMinimaxVoices: (providerId: string) => request<{ catalog: MiniMaxVoiceCatalog; probe?: Record<string, unknown> }>(`/api/v2/providers/${encodeURIComponent(providerId)}/voices/refresh`, json('POST', {})),
